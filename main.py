"""Module includes functions of creation character and
 training process with basic moves."""
...
def attack(char_name: str, char_class: str) -> str:
    """Return the message with damage after attack action."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return the message with blocked damage after defence action."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return the message with damage after special action."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Print message with class specification.
    Intiates training and call action functions.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choosing class of character and print basic description."""
